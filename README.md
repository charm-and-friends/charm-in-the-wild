...
- [Keen Code](https://github.com/mochow13/keen-code) - A context-aware terminal AI coding agent written in Go with multiple providers, MCPs, subagents, Agent Skills, controllable tool output retention, and hashline edits. (_built with Bubbles, Bubble Tea, Glamour, Lip Gloss, and Ultraviolet_)
- [mods](https://github.com/charmbracelet/mods) - AI on the CLI, built for pipelines. (_built with Bubble Tea_)
- [OpenLore](https://github.com/aakarim/OpenLore) - A frontier knowledge base that's minimal, extensible and agent-native. Keeps your context current and insepctable. (_built with Wish_)
...
- [Dstroman](https://github.com/hackctl/dstroman) - Docker object storage handler and manipulator. (_built with Gum_)
...
- [d9c](https://github.com/kirg0/d9c) - A k9s-style terminal UI for managing Docker on remote hosts over TCP or SSH. (_built with Bubbles, Bubble Tea and Lip Gloss_)
...
- [docker-dash](https://github.com/GustavoCaso/docker-dash) - A tool for managing Docker resources from the comfort of your terminal. (_built with Bubbles, Bubble Tea and Lip Gloss_)
...
- [kbu](https://github.com/vulcanshen/kbu) - A single-pane Kubernetes TUI — Tab / Space / Enter / Esc drive everything, with Relatives navigation, YAML compare, and an embedded shell. (_built with Bubbles, Bubble Tea and Lip Gloss_)
...
- [lazygcs](https://github.com/idan-at/lazygcs) - A fast, keyboard-driven TUI for exploring and managing Google Cloud Storage (GCS). (_built with Bubbles, Bubble Tea, Glamour and Lip Gloss_)
...
- [superdive](https://github.com/dukaev/superdive) - A tool for exploring each layer in a Docker image. (_built with Bubbles, Bubble Tea and Lip Gloss_)
...
- [qrypad](https://github.com/wheelibin/qrypad) - A terminal SQL client for Postgres, MySQL and SQLite. (_built with Bubble Tea_)
...
- [campfire](https://github.com/daltonsw/campfire) - Cozy up to your logs with realtime updating and filtering by both level and substring. (_built with Bubble Tea and Lip Gloss_)
- [chezmoi](https://github.com/twpayne/chezmoi) - Securely manage your dotfiles across multiple machines. (_built with Bubble Tea_)
- [ditto](https://github.com/arvingarciabtw/ditto) - A system-wide ASCII keyboard visualizer and keycaster. (_built with Bubble Tea and Lip Gloss_)
- [fifty](https://github.com/balgaly/50-first-sessions) - AI catch-up brief from your git history. Like the morning video in 50 First Dates, for your repos. (_built with Lip Gloss_)
...
- [fuzz.fish](https://github.com/jedipunkz/fuzz.fish) - A Fish shell plugin for fuzzy finding command history, files, Git branches, and worktrees. (_built with Bubble Tea, Bubbles, and Lip Gloss_)
...
- [gh-hookshot](https://www.github.com/marcelblijleven/gh-hookshot) - A GitHub CLI extension for Webhooks and webhook deliveries. (_built with Bubble Tea and Lip Gloss_)
...
- [GitSocial](https://github.com/gitsocial-org/gitsocial) - Git-native cross-forge collaboration: posts, issues, PRs, releases, all in your repo. (_built with Bubble Tea and Lip Gloss_)
...
- [grpctui](https://github.com/alonshuld/grpctui) - A full-screen terminal UI for exploring, calling and debugging gRPC services. (_built with Bubble Tea, Bubbles and Lip Gloss_)
...
- [magetui](https://github.com/dmotylev/magetui) - A docker buildx-style live progress display for mage builds. (_built with Bubble Tea and Lip Gloss_)
...
- [prism](https://github.com/daltonsw/prism) - Make your unit testing downright beautiful. (_built with Lip Gloss_)
- [prompt-manager](https://github.com/nkxxll/oneoffprojs/tree/main/prompt-manager) - Manage your prompt templates for all your CLI coding agents. (_built with Bubbles and Bubble Tea_)
- [prs](https://github.com/dhth/prs) - Stay up to date with your PRs. (_built with Bubble Tea_)
- [revision](https://github.com/bapatchirag/revision) - A lazygit-inspired, fast, keyboard-driven TUI for SVN. (_built with Bubble Tea, Bubbles, and Lip Gloss_)
- [sf-deck](https://github.com/Jacob-Stokes/sf-deck) - A keyboard-first Salesforce workspace for browsing multiple orgs, metadata, records, code, permissions, SOQL, and deployments. (_built with Bubble Tea, Bubbles, and Lip Gloss_)
- [skeleton](https://github.com/termkit/skeleton) - A TUI multi-tab library based on Bubble Tea framework. (_built with Bubble Tea_)
- [SQ](https://github.com/sheenazien8/sq) - A keyboard-first SQL TUI built for VIM users. (_built with Bubble Tea, Lip Gloss_)
...
- [Termon](https://github.com/somus/termon) - A multiplayer monster-battling game over SSH, with original creatures and solo expeditions. (_built with Bubble Tea, Lip Gloss and Wish_)
...
- [VibeWorld](https://github.com/SorBalda/vibeworld) - A multiplayer cyberpunk world for the terminal, with voice chat and a moon you fly to and scream at. (_built with Bubble Tea_)
...
- [dnc](https://github.com/Simon-Hostettler/dnc) - TTRPG character manager. (_built with Bubble Tea, Bubbles and Lip Gloss_)
...
- [hjkl-hero](https://github.com/BosBJJ/hjkl-hero) - An educational Vim Motion roguelike with procedurally generated floors. (_built with Bubble Tea, and Lip Gloss_)
...
- [GoSuki](https://github.com/blob42/gosuki) - No cloud, real time, multi-browser, extension-free bookmark manager. (_built with Bubble Tea_)
...
- [typist](https://github.com/chuma-beep/typist) - A cross platform typing application built for users to master speed and syntax. (_built with Bubble Tea_)
